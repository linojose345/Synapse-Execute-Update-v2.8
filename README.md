...
[![Stars](https://img.shields.io/github/stars/Synapse-Execute-Update-v2.8?style=flat-square)](https://github.com)
...
git clone https://github.com/Synapse-Execute-Update-v2.8.git
cd Synapse-Execute-Update-v2.8
